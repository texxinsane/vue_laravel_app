...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    update: function update(id, color) {
      ...
      this.mute = true;
      window.axios.put("/api/call/".concat(id), {
        color: color
      }).then(function () {
    ...
    del: function del(id) {
      ...
      this.mute = true;
      window.axios["delete"]("/api/call/".concat(id)).then(function () {
    ...
    getFlights: function getFlights() {
      ...
      this.mute = true;
      window.axios.get('/getFlight').then(function (_ref4) {
        var data = _ref4.data;

        _this5.cruds.push(new Crud(data));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  computed: {
    image: function image() {
      return "/images/".concat(this.color, ".png");
    }
  },
  methods: {
...
__webpack_require__(/*! /var/www/vue_laravel_app/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/vue_laravel_app/resources/sass/app.scss */"./resources/sass/app.scss");
